...
width: auto;">
    ...
    <header class="bar-lat">
        <nav>
        <a href="">  <i class='bx bx-arrow-back bx-lg  regre' ></i><li >regresar</li></a> 
...
<h3 style="color: white; position:relative; top:50px; font-size: 20px;"><?php echo $sinopsis; ?></h3>
<a href="<?php echo $url_trailer; ?>"><button  value="Ver trailer" class="ver-trailer">Ver trailer</button></a>
